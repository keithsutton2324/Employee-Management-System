...
desc employee;
insert into employee(first_name,last_name,role_id)values("Jarl","Jarls",1);
insert into employee(first_name,last_name,role_id)values("Joe","Joes",2);
insert into employee(first_name,last_name,role_id)values("Jack","Jacks",3);
insert into employee(first_name,last_name,role_id)values("James","James",4);
INSERT INTO EMPLOYEE(FIRST_NAME,LAST_NAME,ROLE_ID,MANAGER_ID) VALUES("Jim","Jims",5,1);
INSERT INTO EMPLOYEE(FIRST_NAME,LAST_NAME,ROLE_ID,MANAGER_ID) VALUES("Jorge","Jorges",6,2);
INSERT INTO EMPLOYEE(FIRST_NAME,LAST_NAME,ROLE_ID,MANAGER_ID) VALUES("Jason","Jasons",7,4);
INSERT INTO EMPLOYEE(FIRST_NAME,LAST_NAME,ROLE_ID,MANAGER_ID) VALUES("Jackson","Jacksons",6,3);